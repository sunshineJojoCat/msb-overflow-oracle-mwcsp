...
nx.draw(G1, pos1, ax=axes[0], with_labels=True, node_color=node_color, node_size=300, font_weight='bold', font_size=9)
...
nx.draw(G2, pos2, ax=axes[1], with_labels=True, node_color=node_color, node_size=300, font_weight='bold', font_size=9)
...
nx.draw(G3, pos3, ax=axes[2], with_labels=True, node_color=node_color, node_size=300, font_weight='bold', font_size=9)
...
nx.draw(G4, pos4, ax=axes[3], with_labels=True, node_color=node_color, node_size=300, font_weight='bold', font_size=9)
...
nx.draw(G5, pos5, ax=axes[4], with_labels=True, node_color=node_color, node_size=300, font_weight='bold', font_size=9)
